...
namespace Else.Extensibility
{
    ...
    public static class IconTools {
        ...
        /// Modify SHGFI_ICON, causing the function to retrieve the file's small icon. Also used to modify SHGFI_SYSICONINDEX, causing the function to return the handle to the system image list that contains small icon images. The SHGFI_ICON and/or SHGFI_SYSICONINDEX flag must also be set.
        /// </summary>
        internal const uint SHGFI_EXTRALARGEICON = 0x2;
        /// <summary>
        /// Modify SHGFI_ICON, causing the function to retrieve the file's small icon. Also used to modify SHGFI_SYSICONINDEX, causing the function to return the handle to the system image list that contains small icon images. The SHGFI_ICON and/or SHGFI_SYSICONINDEX flag must also be set.
        /// </summary>
        internal const uint SHGFI_JUMBOICON = 0x4;
    ...
    public enum ShellIconSize : uint {
        ...
        /// <summary>
        /// Specifies a Extra-large (48x48) icon.
        /// </summary>
        ExtraLargeIcon = IconTools.SHGFI_ICON | IconTools.SHGFI_EXTRALARGEICON,
        /// <summary>
        /// Specifies a Jumbo (256x256) icon.
        /// </summary>
        JumboIcon = IconTools.SHGFI_ICON | IconTools.SHGFI_JUMBOICON
    }
}